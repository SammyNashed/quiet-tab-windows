 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var me=[[.41233895,.35762064,.18051042],[.2126,.7152,.0722],[.01932141,.11916382,.95034478]],ke=[[3.2413774792388685,-1.5376652402851851,-.49885366846268053],[-.9691452513005321,1.8758853451067872,.04156585616912061],[.05562093689691305,-.20395524564742123,1.0571799111220335]],zt=[95.047,100,108.883];function Pt(r,t,e){return(255<<24|(r&255)<<16|(t&255)<<8|e&255)>>>0}function Gt(r){let t=ct(r[0]),e=ct(r[1]),n=ct(r[2]);return Pt(t,e,n)}function fe(r){return r>>24&255}function ht(r){return r>>16&255}function mt(r){return r>>8&255}function ft(r){return r&255}function Yt(r,t,e){let n=ke,a=n[0][0]*r+n[0][1]*t+n[0][2]*e,o=n[1][0]*r+n[1][1]*t+n[1][2]*e,i=n[2][0]*r+n[2][1]*t+n[2][2]*e,c=ct(a),f=ct(o),g=ct(i);return Pt(c,f,g)}function be(r){let t=tt(ht(r)),e=tt(mt(r)),n=tt(ft(r));return gt([t,e,n],me)}function pe(r,t,e){let n=zt,a=(r+16)/116,o=t/500+a,i=a-e/200,c=kt(o),f=kt(a),g=kt(i),m=c*n[0],y=f*n[1],P=g*n[2];return Yt(m,y,P)}function bt(r){let t=tt(ht(r)),e=tt(mt(r)),n=tt(ft(r)),a=me,o=a[0][0]*t+a[0][1]*e+a[0][2]*n,i=a[1][0]*t+a[1][1]*e+a[1][2]*n,c=a[2][0]*t+a[2][1]*e+a[2][2]*n,f=zt,g=o/f[0],m=i/f[1],y=c/f[2],P=yt(g),d=yt(m),p=yt(y),l=116*d-16,C=500*(P-d),v=200*(d-p);return[l,C,v]}function de(r){let t=j(r),e=ct(t);return Pt(e,e,e)}function Ft(r){let t=be(r)[1];return 116*yt(t/100)-16}function j(r){return 100*kt((r+16)/116)}function Ct(r){return yt(r/100)*116-16}function tt(r){let t=r/255;return t<=.040449936?t/12.92*100:Math.pow((t+.055)/1.055,2.4)*100}function ct(r){let t=r/100,e=0;return t<=.0031308?e=t*12.92:e=1.055*Math.pow(t,1/2.4)-.055,he(0,255,Math.round(e*255))}function ge(){return zt}function yt(r){let t=.008856451679035631,e=24389/27;return r>t?Math.pow(r,1/3):(e*r+16)/116}function kt(r){let t=.008856451679035631,e=24389/27,n=r*r*r;return n>t?n:(116*r-16)/e}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var B=class{constructor(t,e,n,a,o,i){this.roleA=t,this.roleB=e,this.delta=n,this.polarity=a,this.stayTogether=o,this.constraint=i,this.constraint=i??"exact"}};/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var It=class{fromInt(t){return bt(t)}toInt(t){return pe(t[0],t[1],t[2])}distance(t,e){let n=t[0]-e[0],a=t[1]-e[1],o=t[2]-e[2];return n*n+a*a+o*o}};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Be=10,Re=3,Mt=class{static quantize(t,e,n){let a=new Map,o=new Array,i=new Array,c=new It,f=0;for(let S=0;S<t.length;S++){let k=t[S],I=a.get(k);I===void 0?(f++,o.push(c.fromInt(k)),i.push(k),a.set(k,1)):a.set(k,I+1)}let g=new Array;for(let S=0;S<f;S++){let k=i[S],I=a.get(k);I!==void 0&&(g[S]=I)}let m=Math.min(n,f);e.length>0&&(m=Math.min(m,e.length));let y=new Array;for(let S=0;S<e.length;S++)y.push(c.fromInt(e[S]));let P=m-y.length;if(e.length===0&&P>0)for(let S=0;S<P;S++){let k=Math.random()*100,I=Math.random()*201+-100,L=Math.random()*201+-100;y.push(new Array(k,I,L))}let d=new Array;for(let S=0;S<f;S++)d.push(Math.floor(Math.random()*m));let p=new Array;for(let S=0;S<m;S++){p.push(new Array);for(let k=0;k<m;k++)p[S].push(0)}let l=new Array;for(let S=0;S<m;S++){l.push(new Array);for(let k=0;k<m;k++)l[S].push(new jt)}let C=new Array;for(let S=0;S<m;S++)C.push(0);for(let S=0;S<Be;S++){for(let A=0;A<m;A++){for(let E=A+1;E<m;E++){let V=c.distance(y[A],y[E]);l[E][A].distance=V,l[E][A].index=A,l[A][E].distance=V,l[A][E].index=E}l[A].sort();for(let E=0;E<m;E++)p[A][E]=l[A][E].index}let k=0;for(let A=0;A<f;A++){let E=o[A],V=d[A],R=y[V],Y=c.distance(E,R),q=Y,Q=-1;for(let _=0;_<m;_++){if(l[V][_].distance>=4*Y)continue;let it=c.distance(E,y[_]);it<q&&(q=it,Q=_)}Q!==-1&&Math.abs(Math.sqrt(q)-Math.sqrt(Y))>Re&&(k++,d[A]=Q)}if(k===0&&S!==0)break;let I=new Array(m).fill(0),L=new Array(m).fill(0),O=new Array(m).fill(0);for(let A=0;A<m;A++)C[A]=0;for(let A=0;A<f;A++){let E=d[A],V=o[A],R=g[A];C[E]+=R,I[E]+=V[0]*R,L[E]+=V[1]*R,O[E]+=V[2]*R}for(let A=0;A<m;A++){let E=C[A];if(E===0){y[A]=[0,0,0];continue}let V=I[A]/E,R=L[A]/E,Y=O[A]/E;y[A]=[V,R,Y]}}let v=new Map;for(let S=0;S<m;S++){let k=C[S];if(k===0)continue;let I=c.toInt(y[S]);v.has(I)||v.set(I,k)}return v}},jt=class{constructor(){this.distance=-1,this.index=-1}};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Bt=class{static quantize(t){let e=new Map;for(let n=0;n<t.length;n++){let a=t[n];fe(a)<255||e.set(a,(e.get(a)??0)+1)}return e}};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Qt=class extends F{constructor(t,e,n,a=F.DEFAULT_SPEC_VERSION,o=F.DEFAULT_PLATFORM){super({sourceColorHct:t,variant:s.CONTENT,contrastLevel:n,isDark:e,platform:o,specVersion:a})}};/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var te=class extends F{constructor(t,e,n,a=F.DEFAULT_SPEC_VERSION,o=F.DEFAULT_PLATFORM){super({sourceColorHct:t,variant:s.EXPRESSIVE,contrastLevel:n,isDark:e,platform:o,specVersion:a})}};/**
 * @license
 * Copyright 2023 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ee=class extends F{constructor(t,e,n,a=F.DEFAULT_SPEC_VERSION,o=F.DEFAULT_PLATFORM){super({sourceColorHct:t,variant:s.FIDELITY,contrastLevel:n,isDark:e,platform:o,specVersion:a})}};/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var re=class extends F{constructor(t,e,n,a=F.DEFAULT_SPEC_VERSION,o=F.DEFAULT_PLATFORM){super({sourceColorHct:t,variant:s.FRUIT_SALAD,contrastLevel:n,isDark:e,platform:o,specVersion:a})}};/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ne=class extends F{constructor(t,e,n,a=F.DEFAULT_SPEC_VERSION,o=F.DEFAULT_PLATFORM){super({sourceColorHct:t,variant:s.MONOCHROME,contrastLevel:n,isDark:e,platform:o,specVersion:a})}};/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ae=class extends F{constructor(t,e,n,a=F.DEFAULT_SPEC_VERSION,o=F.DEFAULT_PLATFORM){super({sourceColorHct:t,variant:s.NEUTRAL,contrastLevel:n,isDark:e,platform:o,specVersion:a})}};/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var oe=class extends F{constructor(t,e,n,a=F.DEFAULT_SPEC_VERSION,o=F.DEFAULT_PLATFORM){super({sourceColorHct:t,variant:s.RAINBOW,contrastLevel:n,isDark:e,platform:o,specVersion:a})}};/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var ie=class extends F{constructor(t,e,n,a=F.DEFAULT_SPEC_VERSION,o=F.DEFAULT_PLATFORM){super({sourceColorHct:t,variant:s.TONAL_SPOT,contrastLevel:n,isDark:e,platform:o,specVersion:a})}};/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var se=class extends F{constructor(t,e,n,a=F.DEFAULT_SPEC_VERSION,o=F.DEFAULT_PLATFORM){super({sourceColorHct:t,variant:s.VIBRANT,contrastLevel:n,isDark:e,platform:o,specVersion:a})}};/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Le={desired:4,fallbackColorARGB:4282549748,filter:!0};function Oe(r,t){return r.score>t.score?-1:r.score<t.score?1:0}var rt=class r{constructor(){}static score(t,e){let{desired:n,fallbackColorARGB:a,filter:o}={...Le,...e},i=[],c=new Array(360).fill(0),f=0;for(let[d,p]of t.entries()){let l=D.fromInt(d);i.push(l);let C=Math.floor(l.hue);c[C]+=p,f+=p}let g=new Array(360).fill(0);for(let d=0;d<360;d++){let p=c[d]/f;for(let l=d-14;l<d+16;l++){let C=lt(l);g[C]+=p}}let m=new Array;for(let d of i){let p=lt(Math.round(d.hue)),l=g[p];if(o&&(d.chroma<r.CUTOFF_CHROMA||l<=r.CUTOFF_EXCITED_PROPORTION))continue;let C=l*100*r.WEIGHT_PROPORTION,v=d.chroma<r.TARGET_CHROMA?r.WEIGHT_CHROMA_BELOW:r.WEIGHT_CHROMA_ABOVE,S=(d.chroma-r.TARGET_CHROMA)*v,k=C+S;m.push({hct:d,score:k})}m.sort(Oe);let y=[];for(let d=90;d>=15;d--){y.length=0;for(let{hct:p}of m)if(y.find(C=>_t(p.hue,C.hue)<d)||y.push(p),y.length>=n)break;if(y.length>=n)break}let P=[];y.length===0&&P.push(a);for(let d of y)P.push(d.toInt());return P}};rt.TARGET_CHROMA=48;rt.WEIGHT_PROPORTION=.7;rt.WEIGHT_CHROMA_ABOVE=.3;rt.WEIGHT_CHROMA_BELOW=.1;rt.CUTOFF_CHROMA=5;rt.CUTOFF_EXCITED_PROPORTION=.01;/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */export{D as Hct,Ot as QuantizerCelebi,Qt as SchemeContent,te as SchemeExpressive,ee as SchemeFidelity,re as SchemeFruitSalad,ne as SchemeMonochrome,ae as SchemeNeutral,oe as SchemeRainbow,ie as SchemeTonalSpot,se as SchemeVibrant,rt as Score,Ve as argbFromHex,Pt as argbFromRgb,Se as hexFromArgb};
